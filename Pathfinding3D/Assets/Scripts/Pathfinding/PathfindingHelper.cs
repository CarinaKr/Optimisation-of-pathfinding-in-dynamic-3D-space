    ...
    public class PathfindingHelper : ScriptableObject
    {
        ...
        public bool LineOfSight(Node from, Node to, bool onDefaultObstacleLayer)
        {
            ...
            try
            {
                ...
                bool inSight = !Physics.Raycast(from.globalPosition, direction, out hit, direction.magnitude,
                    currentObstacleLayer, QueryTriggerInteraction.Collide);
                if (inSight)
                {
                    inSight = !Physics.SphereCast(from.globalPosition, playerRadius, direction, out hit,
                        direction.magnitude, /*1 <<*/ currentObstacleLayer, QueryTriggerInteraction.Collide);
                }
        ...
        public bool LineOfSight(Vector3 from, Node to, bool onDefaultObstacleLayer)
        {
            ...
            try
            {
                ...
                bool inSight = !Physics.Raycast(from, direction, out hit, direction.magnitude, currentObstacleLayer,
                    QueryTriggerInteraction.Collide);
                if (inSight)
                {
                    inSight = !Physics.SphereCast(from, playerRadius, direction, out hit, direction.magnitude, /*1 <<*/
                        currentObstacleLayer, QueryTriggerInteraction.Collide);
                }
        ...
        public bool LineOfSight(Vector3 from, Vector3 to, bool onDefaultObstacleLayer)
        {
            ...
            try
            {
                ...
                if (inSight)
                {
                    inSight = !Physics.SphereCast(from, playerRadius, direction, out hit, direction.magnitude, currentObstacleLayer, QueryTriggerInteraction.Collide);
                }
