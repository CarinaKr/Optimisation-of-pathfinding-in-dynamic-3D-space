...
namespace UnityAsyncAwaitUtil
{
    ...
    {
        private const string AssetBundleSampleUrl =
            "http://www.stevevermeulen.com/wp-content/uploads/2017/09/teapot.unity3d";

        private const string AssetBundleSampleAssetName = "Teapot";

        [SerializeField] private TestButtonHandler.Settings _buttonSettings;
        ...
        private void PrintCurrentThreadContext(string prefix = null)
        {
            Debug.Log(string.Format("{0}Current Thread: {1}, Scheduler: {2}",
                prefix == null ? "" : prefix + ": ", Thread.CurrentThread.ManagedThreadId,
        ...
        private IEnumerator<string> WaitForString()
        {
            ...
            while (Time.realtimeSinceStartup - startTime < 2) yield return null;
